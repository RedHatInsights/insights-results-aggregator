...
# copy just the content of the external rules + content config file
COPY --from=builder /rules-content/content/external/rules/ \
    /rules-content/content/config.yaml \
    /rules-content/

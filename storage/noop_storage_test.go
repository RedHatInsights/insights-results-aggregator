...
func TestNoopStorage_Methods(t *testing.T) {
	...
	_, _ = noopStorage.GetUserFeedbackOnRuleDisable("", "", "", 0)
	_, _ = noopStorage.GetUserFeedbackOnRule("", "", "", 0)
...
func TestNoopStorage_Methods_Cont(t *testing.T) {
	...
	_, _ = noopStorage.GetUserFeedbackOnRules("", nil, 0)
	...
	_, _ = noopStorage.GetUserDisableFeedbackOnRules("", []types.RuleOnReport{}, 0)
	_, _ = noopStorage.DoesClusterExist("")
	_, _ = noopStorage.ListOfDisabledRules(types.OrgID(1))
	_, _ = noopStorage.ListOfReasons(0)

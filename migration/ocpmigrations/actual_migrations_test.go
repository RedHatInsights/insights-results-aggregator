...
func getMaxVersion() migration.Version {
	return migration.Version(len(ocpmigrations.UsableOCPMigrations))
}
...
func TestMigrationsOneByOne(t *testing.T) {
	...
	testMigrations := []migration.Migration{}
...
func TestMigration4_CreateTableError(t *testing.T) {
	...
	mig4 := ocpmigrations.Mig0004ModifyClusterRuleUserFeedback

...
DEPLOY_FRONTENDS=true   # needed for front end tests

export IQE_PLUGINS="ccx"
# Run all pipeline tests
export IQE_MARKER_EXPRESSION="pipeline or ui"   # run also ui tests
# Skip fuzz_api_v1/fuzz_api_v2 tests. The take long and not much useful for PR.
export IQE_FILTER_EXPRESSION="test_page or test_rest_api or test_basic"

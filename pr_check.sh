...
COMPONENTS="ingress ccx-data-pipeline ccx-insights-results valkey-writer dvo-writer dvo-extractor insights-content-service ccx-smart-proxy ccx-mock-ams ccx-upgrades-rhobs-mock" # space-separated list of components to load
